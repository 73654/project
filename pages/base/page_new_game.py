...
class BasePageNewGame(BasePage):
    ...
    def zh_new_game(cls):
        """新手流程"""
        with dog.step(f"{cls.page_name}-点击小手"):
        ...
        with dog.step(f"{cls.page_name}-点击瞄准"):
        ...
        with dog.step(f"{cls.page_name}-点击搜索"):
            # 国服他们应该是icon配错了，应该是search图标，现在是hand了，所以这里用hand
            find_feature_until_end(end_feature_names=["hand"], feature_names=["skip", "miaozhun", "duihuakuang1", "duihuakuang2", "miaozhun2"])
            cls.take_step_screenshot("点击搜索")
        with dog.step(f"{cls.page_name}-点击日记"):
        ...
        with dog.step(f"{cls.page_name}-点击翻页"):
        ...
        with dog.step(f"{cls.page_name}-点击任务"):
        ...
        with dog.step(f"{cls.page_name}-点击搜索"):
            ...
            cls.take_step_screenshot("点击搜索")
        with dog.step(f"{cls.page_name}-点击工作"):
        ...
        with dog.step(f"{cls.page_name}-点击布雷迪"):
        ...
        with dog.step(f"{cls.page_name}-点击返回"):
        ...
        with dog.step(f"{cls.page_name}-点击挖掘"):
        ...
        with dog.step(f"{cls.page_name}-点击石头"):
        ...
        with dog.step(f"{cls.page_name}-点击挖掘"):
            ...
            cls.take_step_screenshot("点击挖掘")
        with dog.step(f"{cls.page_name}-点击建造"):
        ...
        with dog.step(f"{cls.page_name}-点击基础"):
        ...
        with dog.step(f"{cls.page_name}-点击客厅"):
        ...
        with dog.step(f"{cls.page_name}-点击建造完成"):
        ...
        with dog.step(f"{cls.page_name}-点击建造完成"):
            ...
            cls.take_step_screenshot("点击建造完成")
        with dog.step(f"{cls.page_name}-点击上楼"):
